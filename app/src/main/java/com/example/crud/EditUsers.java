...
public class EditUsers extends Fragment {
    ...
    String usuario_id, nivel_id, password, usuario;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        nivel_id = bundle.getString("nivel_id");
        usuario_id = bundle.getString("usuario_id");
        EditUsers = "http://192.168.0.8:8080/editCat/" + usuario_id;
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        insertNivel.setText(nivel_id);
        insertPassword.setText(password);
        insertUsuario.setText(usuario);
